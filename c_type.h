...
#define BYTESIZE 8
char BITMAP_PRE[8] = {0x01<<0, 0x01<<1, 0x01<<2, 0x01<<3, 0x01<<4, 0x01<<5, 0x01<<6, 0x01<<7};
...
inline void BitmapInit(char* buf, int n)
{
    memset(buf, 0, sizeof(char)*n);
}
 
inline void BitmapSet(char* buf, int n, int i){
    int add = i/BYTESIZE;
    int pos = i%BYTESIZE;
    if(add>=n) {
        return ;
...
inline int BitmapCheck(char* buf, int n, int i){
    int add = i/BYTESIZE;
    int pos = i%BYTESIZE;
